          ...
          {timelineData.map((item, idx) => (
            <React.Fragment key={item.year}>
              <div
                ...
                style={{ opacity: 1, transform: 'none' }}>
                <div
                  className={`absolute left-0 md:left-1/2 top-0 w-14 h-14 bg-gray-900 border-4 border-emerald-500 rounded-full transform -translate-x-1/2 flex items-center justify-center shadow-lg shadow-emerald-500/20 z-10${item.reverse ? ' -ml-4' : ''}`}>
                  <div
