...
const Contact = () => {
  return (
    <>
      <div id="contact" className=" mb-24 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                ...
                <div className="space-y-2 mt-3">
                  ...
                  <div className="flex space-x-3 pl-4">
                    <a
                      ...
                      className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800/80 border border-gray-700 hover:border-teal-500/50 hover:bg-gray-800 transition-all duration-300 group/social">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800/80 border border-gray-700 hover:border-cyan-500/50 hover:bg-gray-800 transition-all duration-300 group/social">
            ...
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900/90 to-gray-800/70 backdrop-blur-sm border border-gray-800 shadow-xl p-8">
              ...
              <div className="relative z-10">
                ...
                <form className="space-y-6" style={{ opacity: 1 }}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
                      ...
                      <div className="relative group">
                        <input
                          id="name"
                          className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none transition-all duration-300"
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative group">
                      <textarea
                        ...
                        name="message"
                        rows={4}
                        className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none transition-all duration-300 resize-none"
                  ...
                  <button
                    type="submit"
                    className="w-full relative overflow-hidden group rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 px-6 py-4 text-white font-medium transition-all duration-300"
                    tabIndex={0}
                    style={{ transform: 'none' }}>
